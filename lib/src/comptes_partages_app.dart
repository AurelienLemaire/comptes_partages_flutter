...
import 'package:comptes_partages_flutter/src/views/test_view.dart';
import 'package:comptes_partages_flutter/src/views/transaction_form_view.dart';
import 'package:comptes_partages_flutter/src/views/welcome_view.dart';
...
class ComptesPartagesApp extends StatelessWidget {
  const ComptesPartagesApp({
    Key? key,
            ...
            return MaterialPageRoute<void>(
              ...
              builder: (BuildContext context) {
                switch (routeSettings.name) {
                  ...
                  case TransactionFormView.routeName:
                    return TransactionFormView();
                  case CarnetStatsView.routeName:
                    return CarnetStatsView();
                  case CarnetPortfolioView.routeName:
                    return CarnetPortfolioView();
                  case CarnetFormView.routeName:
                    return CarnetFormView();
